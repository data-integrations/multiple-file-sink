...
public class MultipleFileBatchTextSink extends SnapshotFileBatchSink<String, NullWritable> {
  private StructuredToTextTransformer recordTransformer;
  private SnapshotFileBatchTextSinkConfig config;

  public MultipleFileBatchTextSink(SnapshotFileBatchTextSinkConfig config) {
    super(config);
    this.config = config;
  }
