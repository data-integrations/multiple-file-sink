 ...
 */
public class MultipleSnapshotFilesetSinkOutputFormat<T> extends AvroOutputFormatBase<AvroKey<T>, NullWritable> {
   ...
   * Constructor.
   */
  public MultipleSnapshotFilesetSinkOutputFormat() {
   ...
   */
  protected MultipleSnapshotFilesetSinkOutputFormat(RecordWriterFactory recordWriterFactory) {
