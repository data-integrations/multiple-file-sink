 ...
 */
public class CustomizedAvroKeyOutputFormat<T> extends AvroOutputFormatBase<AvroKey<T>, NullWritable> {
   ...
   * Constructor.
   */
  public CustomizedAvroKeyOutputFormat() {
   ...
   */
  protected CustomizedAvroKeyOutputFormat(RecordWriterFactory recordWriterFactory) {
